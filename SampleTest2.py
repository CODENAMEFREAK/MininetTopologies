...
class MyCustomTopo(Topo):
    ...
    def build(self):
        ...
        core_switch_1 = self.addSwitch('C_S_1', switch=OVSSwitch, controller=RemoteController, ip='192.168.1.4', port=6633)

        aggr_switch_1 = self.addSwitch('A_S_1', switch=OVSSwitch, controller=RemoteController, ip='192.168.1.4', port=6633)
        aggr_switch_2 = self.addSwitch('A_S_2', switch=OVSSwitch, controller=RemoteController, ip='192.168.1.4', port=6633)

        tor_switch_1 = self.addSwitch('TOR_S_1', switch=OVSSwitch, controller=RemoteController, ip='192.168.1.4', port=6633)
        tor_switch_2 = self.addSwitch('TOR_S_2', switch=OVSSwitch, controller=RemoteController, ip='192.168.1.4', port=6633)
        tor_switch_3 = self.addSwitch('TOR_S_3', switch=OVSSwitch, controller=RemoteController, ip='192.168.1.4', port=6633)
        tor_switch_4 = self.addSwitch('TOR_S_4', switch=OVSSwitch, controller=RemoteController, ip='192.168.1.4', port=6633)
