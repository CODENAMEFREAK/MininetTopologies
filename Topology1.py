...
class MyCustomTopo(Topo):
    ...
    def build(self):
        ...
        #aggr_switch_1 = self.addSwitch('agrsw1', switch=OVSSwitch)
        #aggr_switch_2 = self.addSwitch('agrsw2', switch=OVSSwitch)

        tor_switch_1 = self.addSwitch('tors1', switch=OVSSwitch)
        tor_switch_2 = self.addSwitch('tors2', switch=OVSSwitch)
        tor_switch_3 = self.addSwitch('tors3', switch=OVSSwitch)
        tor_switch_4 = self.addSwitch('tors4', switch=OVSSwitch)
